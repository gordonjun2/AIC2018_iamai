...
# class ReID_iamai(object):
#     def __init__(self):
#         ckpt = "./ckpt/model_880_base.ckpt"
#         n_layers = 50
#         self.model = ResNet_Loader(ckpt, n_layers, output_color=False,batch_size=2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size',default=2,help='batch_size for inferencing')
